  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    while (cityXY.hasNext()) {
      ...
      if (pairs.contains(city)) {
         ...
         * (0,0) is the lower left corner (by comparison, in the default JFrame
         * layout, (0,0) is in the upper left corner, thus points on a grid
         * appear inverted about y axis).
         */
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        try {
          ...
          if (origin.equals(destination)) {
            JOptionPane.showMessageDialog(frame, "Good news: you don't have to travel, " + "you're already there!",
                "The Shortest Path", JOptionPane.PLAIN_MESSAGE);
          } else {

            JOptionPane.showMessageDialog(frame,
                "The shortest path is from " + graph.getPath() + "\n\nThe total distance is " + graph.getShortestDist(),
                "The Shortest Path", JOptionPane.PLAIN_MESSAGE);
          }
