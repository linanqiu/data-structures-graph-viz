...
public class BinaryHeap<AnyType extends Comparable<? super AnyType>> {
   ...
   * 
   *          modified by sab2229: percolate down to make it into a MAX heap,
   *          with the biggest element at top.
   */
  ...
  /*
   * // Test program public static void main( String [ ] args ) throws
   * UnderflowException { int numItems = 10000; BinaryHeap<Integer> h = new
   * BinaryHeap<Integer>( ); int i = 37;
   * 
   * for( i = 37; i != 0; i = ( i + 37 ) % numItems ) h.insert( i ); for( i = 1;
   * i < numItems; i++ ) if( h.deleteMin( ) != i ) System.out.println( "Oops! "
   * + i ); }
   */
}