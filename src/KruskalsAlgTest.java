...
public class KruskalsAlgTest {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    while (cityxy.hasNext()) {
      ...
      /*
       * Flips the y-coordinates to correspond with real xy layout, where (0,0)
       * is the lower left corner (by comparison, in the default JFrame layout,
       * (0,0) is in the upper left corner, thus points on a grid appear
       * inverted about y axis).
       */
    ...
    JLabel label = new JLabel("Please click 'Go!' to find a " + "MinSpanning Tree!");
    ...
    goButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        try {
          graph.KruskalsAlg();
          graph.repaint();
          JOptionPane.showMessageDialog(frame, "The MST contains the following edges: " + graph.getMST()
              + "\n\nTotal distance is " + graph.getShortestDist(), "Minimum Spanning Tree", JOptionPane.PLAIN_MESSAGE);
