...
public class Display extends JFrame {
  ...
  public Display() {
    ...
    gbc_lblGenerateRandomGraph.gridy = 3;
    ...
    gbc_btnGenerateRandomGraph.gridx = 2;
    gbc_btnGenerateRandomGraph.gridy = 3;
    ...
    gbc_lblNearestNeighbor.gridy = 4;
    ...
    gbc_lblNearestneighbordistance.gridy = 4;
    ...
    btnNearestNeighbor.addMouseListener(new MouseAdapter() {
      @Override
      public void mouseReleased(MouseEvent e) {
        System.out.println("Running doNearestNeighbor()");
        panel.graph.doNearestNeighbor();
        System.out.println("Getting paths from getNearestNeighborPath()");
        List<Edge> path = panel.graph.getNearestNeighborPath();
        double distance = 0;
        for (Edge edge : path) {
    ...
    gbc_btnNearestNeighbor.gridx = 2;
    gbc_btnNearestNeighbor.gridy = 4;
    ...
    gbc_lblBruteforcedistance.gridy = 5;
    ...
    btnBruteForce.addMouseListener(new MouseAdapter() {
      @Override
      public void mouseReleased(MouseEvent e) {
        System.out.println("Running doBruteForce()");
        panel.graph.doBruteForce();
        System.out.println("Getting paths from getBruteForcePath()");
        List<Edge> path = panel.graph.getBruteForcePath();
        System.out.println("Calculating distance of path");
        double distance = 0;
        for (Edge edge : path) {
          distance += edge.distance;
        }
    ...
    gbc_btnBruteForce.gridx = 2;
    gbc_btnBruteForce.gridy = 5;
        ...
        if (n > 20) {
          ...
          int m = JOptionPane.showOptionDialog(panel,
              "You are about to generate " + n
                  + " vertices.\nDrawing this may slow down your computer. Running the algorithms on a graph\n" + ""
                  + "larger than 20 vertices will probably take forever.\nYour computer may flip out on strike."
